...
const eventDetails = {
  name: '7ALA: Sunrise Session',
  date: '07 February',
  timing: '3:00 AM – 12:00 PM',
  lineup: 'Mark | Nour Odin | Assem | HN2 | Dizzy + Big surprise DJ'
};

app.post('/api/reservations', async (req, res) => {
  try {
    const { fullName, email, phone, guests, groupType, paymentMethod, paymentReference, paymentAmount } = req.body;

    if (!fullName || !email || !phone || !guests || !groupType || !paymentMethod || !paymentReference) {
